...
//
//class SportsceneProductSearch extends SearchDelegate {
//  @override
...
//    var _providerData = Provider.of<SportsceneProductNameList>(context).items;
...
//
//        dynamic response = await _sportsceneData.getSingleProductData(result);
