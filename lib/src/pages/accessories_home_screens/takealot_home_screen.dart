...
class TakealotHomeScreen extends StatefulWidget {
  ...
  @override
  _TakealotHomeScreenState createState() => _TakealotHomeScreenState();
}
...
//                Text('Would you like to approve of this message?'),
  ...
  void _testTakealotConnection() async {
    if (await TestConnection.checkForConnection()) {
  ...
  Future<void> _getDataOnRefresh() async {
    if (await TestConnection.checkForConnection()) {
      ...
      data = Provider.of<TakealotAllProductList>(context, listen: false).data;
      ...
      child: RefreshIndicator(
        ...
        child: ListView(
          ...
          children: [
              ...
              children: [
                Positioned(
                  child: CustomPaint(
                    ...
                    painter: HomeBGCustomPaint(color: kBgTakealot),
                  ),
                ),
                Column(
            ...
            BestBuys(
              bestBuys: bestBuys,
              color: kBgTakealot.withOpacity(.1),
            ),
            SizedBox(
              height: 40,
            ),
                    ...
                    Material(
                      child: TabBar(
                        indicator: BoxDecoration(
                            border: Border.all(color: kBgTakealot, width: 5),
...
//                  horizontalMargin: 20,
              dataRowHeight: 55,
              headingRowColor:
                  MaterialStateProperty.all(kBgTakealot.withOpacity(.3)),
              columns: [
                DataColumn(
